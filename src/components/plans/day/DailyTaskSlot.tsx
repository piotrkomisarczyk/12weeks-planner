...
export function DailyTaskSlot({
  ...
  return (
    <div className={cn("rounded-lg border-2 overflow-hidden", colors.border, colors.bg)}>
        ...
        <AccordionItem value="open" className="border-0">
          ...
          <AccordionContent className="pb-0">
            ...
            <div className="p-4 space-y-2">
              ...
              {isAdding && (
                <div className="mt-2">
                  <InlineAddTask onAdd={handleAdd} onCancel={handleCancel} placeholder="Enter task title..." />
                </div>
              )}
            </div>
            ...
            <div className="px-4 pb-4">
              {!isAdding && (
                <Tooltip>
                  ...
                  {(isReadOnly || isFull) && (
                    <TooltipContent>
                      <p>{isReadOnly ? getDisabledTooltip(planStatus, "general") : `Slot Full (max ${limit})`}</p>
                    </TooltipContent>
                  )}
                </Tooltip>
              )}
