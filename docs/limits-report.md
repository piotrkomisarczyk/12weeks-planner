...
- ✓ **Minimum 1, Maximum 5 goals** per plan (enforced by trigger `validate_goal_count_per_plan`)
...
- ✓ **Maximum 10 subtasks** per weekly goal (enforced by trigger `validate_weekly_subtask_count`)
- ✓ **Maximum 10 ad-hoc tasks** per week (enforced by trigger `validate_ad_hoc_task_count`)
...
### **Goals Endpoints**
- ✓ **Minimum 1, Maximum 5 goals** per plan
- ✓ Progress percentage: **0-100%**
- ✓ Position range: **1-5**
...
- ✓ Due day range: **1-7**
- ✓ Title max length: **255 characters**
- ✓ **Maximum 10 weekly subtasks** per weekly goal
- ✓ **Maximum 10 ad-hoc tasks** per week
...
- ✓ **0-10 subtasks** per weekly goal
- ✓ **0-10 ad-hoc tasks** per week
- ✓ Priority: **A, B, C**
...
- ✓ Total: **10 tasks** displayed per day
...
- Tasks per weekly goal: 0-10 subtasks
- Ad-hoc tasks: 0-10 per week
