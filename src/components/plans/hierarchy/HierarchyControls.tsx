  ...
  return (
    <div className="flex items-center gap-6 text-sm">
      <div className="flex items-center space-x-2">
        <Checkbox id="show-completed" checked={filters.showCompleted} onCheckedChange={handleShowCompletedChange} />
        <Label htmlFor="show-completed">Show completed</Label>
      </div>
      <div className="flex items-center space-x-2">
        <Checkbox id="show-all-weeks" checked={filters.showAllWeeks} onCheckedChange={handleShowAllWeeksChange} />
